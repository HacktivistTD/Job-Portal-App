...
function AccountInfo({ profileInfo }) {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="flex items-baseline dark:border-green-500 justify-between pb-6 border-b pt-24">
        <h1 className="text-4xl font-bold dark:text-green-500 tracking-tight text-gray-950">
          Account Details
        </h1>
      </div>
